...
public class Rotation : MonoBehaviour
{
    ...
    public float horizontalRotationRestrict;
    public float verticalRotationRestrict;
    ...
    void Update()
    {
        ...
        horizontalRotation = Mathf.Clamp(horizontalRotation, -horizontalRotationRestrict, horizontalRotationRestrict);
        ...
        verticalRotation = Mathf.Clamp(verticalRotation, -verticalRotationRestrict, verticalRotationRestrict);
